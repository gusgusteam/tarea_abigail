...
<td><?php echo $row['usuario'];?></td>
    ...
    <td><?php echo $row['correo'];?></td>                                      
                      ...
                      ?>
  <a class="small-box-footer btn-print"  href="<?php  echo "eliminar_cliente.php?cid=$cid";?>" onClick="return confirm('¿Está seguro de que quieres eliminar usuario??');"><i class="glyphicon glyphicon-remove" ></i></a>
  <a class="small-box-footer btn-print"  href="<?php  echo "editar_password.php?cid=$cid";?>"><i class="glyphicon glyphicon-eye-open"></i></a>     
<a class="btn btn-danger btn-print" href="<?php  echo "editar_cliente.php?cid=$cid";?>"  role="button">Editar</a>
             <?php
            //          }
                      ?>
