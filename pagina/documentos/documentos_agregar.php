...
#buscar{
 ...
 <!--end of modal-->
        ...
        <form class="form-horizontal" method="post" action="documentos_add.php" enctype='multipart/form-data'>
                   ...
                   <div class="row">
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                        <label for="date" >Titulo documento</label>
                      ...
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control pull-right" id="titulo_documentos" name="titulo_documentos" required >
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">
