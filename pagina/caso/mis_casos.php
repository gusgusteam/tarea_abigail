...
#buscar{
 ...
 <!--end of modal-->
                  ...
                  <div class="box-header">
                  <h3 class="box-title"> LISTA CASOS</h3>
                </div><!-- /.box-header -->
...
$id_usuario=$_SESSION['id'];
 ...
 where s.estado_caso='abierto' and s.id_usuario='$id_usuario'")or die(mysqli_error());
    $i=0;
...
<a class="btn btn-success btn-print" href="<?php  echo "../caso/tarifa_pago.php?id_caso=$id_caso";?>"  target="_blank"  role="button">Tarifa</a>

<a class="btn btn-danger btn-print" href="<?php  echo "../caso/audiencia.php?id_caso=$id_caso";?>"    role="button">Fecha audiencia</a>
<a class="btn btn-danger btn-print" href="<?php  echo "../caso/editar_caso.php?id_caso=$id_caso";?>"  target="_blank"  role="button">Editar</a>
<a class="btn btn-primary btn-print" href="<?php  echo "../caso/archivar_caso.php?id_caso=$id_caso";?>"  onClick="return confirm('¿Está seguro de que quieres archivar??');"  role="button">Archivar</a>
      <?php
