...
?>
 ...
 <!--end of modal-->
              ...
              <a class="btn btn-warning btn-print" href="mis_casos.php"    style="height:25%; width:15%; font-size: 12px " role="button">Regresar</a>
                      <form class="form-horizontal" method="post" action="tarifa_pago_add.php" enctype='multipart/form-data'>
     ...
     <div class="row">
            ...
            <input type="text" class="form-control" id="cantidad" name="cantidad"  >
                   ...
                   <div class="row">
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                        <label for="date" >Metodo de pago</label>
                 
                      </div><!-- /.form group -->
                    </div>
                       <div class="col-md-4 btn-print">
                      <div class="form-group">
                 <select class="form-control select2" name="metodo_pago" required>
