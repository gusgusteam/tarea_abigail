...
?>
   ...
   <td>
                 <a title="Descargar Archivo" href="subir_audiencia/<?php echo $archivo; ?>" download="<?php echo $archivo; ?>" style="color: blue; font-size:18px;"> <span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> </a>
            </td>
                      </tr>
