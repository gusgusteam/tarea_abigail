        ...
        <td><?php echo $row['fecha'];?></td>              
         <td><?php echo $row['fecha_audiencia'];?></td>     
           <td><?php echo $row['notas'];?></td>                                      
               ...
               <td>
                 <a title="Descargar Archivo" href="../caso/subir_audiencia/<?php echo $archivo; ?>" download="<?php echo $archivo; ?>" style="color: blue; font-size:18px;"> <span class="glyphicon glyphicon-download-alt" aria-hidden="true"></span> </a>
            </td>
                      </tr>
